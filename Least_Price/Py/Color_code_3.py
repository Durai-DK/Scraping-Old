...
excel_path = {
    ...
    "Mobile": r"D:\Durai\Scraping\Mobile\Save Data\Final Files\Mobiles_Price_List " + date + ".xlsx",
    "Tv": r"D:\Durai\Scraping\Tv\Save Data\Final Files\Tv Price List " + date + ".xlsx",
    "Kitchen appliances": r"D:\Durai\Scraping\Kitchen_appliances\Save Data\Final Files\Kitchen Appliance Price List " + date + ".xlsx",
...
print(Flipkart)
data = pd.read_excel(r"D:\Durai\Scraping\Accessories\Save Data's\Final Files\Accessories Price List " + date + ".xlsx")

print(data.columns)

poorvika_data = data["Poorvika price"]
Flipkart_data = data["Flipkart Price"]

# print(poorvika_data)
print("NA :",Flipkart_data.isnull().sum())
print("> :",data["Poorvika price"].equals(data["Flipkart Price"]))
...
# print(greater)
# print(lesser)
Flipkart["equal"] = equal
Flipkart["grater"] = greater
Flipkart["lesser"] = lesser
Flipkart["NA"] = Flipkart_data.isnull().sum()
Flipkart["Total"] = equal + greater + lesser + Flipkart_data.isnull().sum()
print(Flipkart)
...
#     dk_ws["d6"] = "Price Comparison - " + key + " - " + date
